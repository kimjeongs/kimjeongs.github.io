...
gsap.to(hederTit, {  
  scrollTrigger :{
    ...
    scrub: true,
    delay:3, 
    toggleClass: {targets: hederTit, className: "active"},
    // markers:true,
  },
  color:"#F8F8F4"
}); 
...
ani1.to(sec02Viedo, {scale:25, borderRadius:0, duration:4, top:400, width:80 })
gsap.set($('.video_wrap'), {
...
gsap.to(txt1, {  
  scrollTrigger :{
    ...
    scrub: true,
    toggleClass: {targets: txt1, className: "off"},
    // markers:true,
  },
  autoAlpha:0,
});
...
gsap.to(txt2, {
  scrollTrigger: {
    ...
    scrub: true,
    toggleClass: {targets: txt2, className: "off"},
    // markers:true,
  },
  color: "#F8F8F4",
  autoAlpha:1,
